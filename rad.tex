...
Kako bismo precizno analizirali ponašanje populacije uličnih pasa kroz vreme, jednačinu rešavamo egzaktno. Uočavamo da je jednačina nelinearna obična diferencijalna jednačina prvog reda koja se može rešiti metodom razdvajanja promenljivih:
\begin{equation}
...
% Kada budete imali sliku izjave, stavite je u isti folder gde je i .tex fajl.
% Ako se slika zove izjava_o_autorstvu.jpg, uklonite znak % ispred naredne linije:
% \includegraphics[width=\textwidth]{izjava_o_autorstvu.jpg}
